...
namespace EyouSoft.DAL.CompanyStructure
{
    ...
    public class CompanyInfo : DALBase, IDAL.CompanyStructure.ICompanyInfo
    {
        ...
        public Model.CompanyStructure.CompanyInfo GetModel(int companyId, int systemId)
        {
            ...
            strSql.AppendFormat(" ; select FileId,FilePath from tbl_ComapnyFile where CompanyId = {0} AND ItemType={1} order by [IdentityId] desc ", companyId, (int)AnnexType.公司信息);
        ...
        public int AddCompanyFile(int companyId, IList<string> list)
        {
            ...
            {
                strSql.AppendFormat(
                    " insert into tbl_ComapnyFile (FileId,CompanyId,FilePath,ItemType,ItemId) values (@FileId{0},@CompanyId,@FilePath{0},@ItemType,@CompanyId); ",
                    i);
                _db.AddInParameter(
            ...
            _db.AddInParameter(dc, "@ItemType", DbType.Byte, AnnexType.公司信息);
