...
namespace EyouSoft.DAL.CompanyStructure
{
    ...
    public class Department : DALBase, IDAL.CompanyStructure.IDepartment
    {
        ...
        private const string SqlInsertDepartment = " insert into tbl_CompanyDepartment (DepartName,PrevDepartId,DepartManger,ContactTel,ContactFax,Remark,CompanyId,OperatorId,IssueTime,ZxsId) values(@DepartName,@PrevDepartId,@DepartManger,@ContactTel,@ContactFax,@Remark,@CompanyId,@OperatorId,@IssueTime,@ZxsId); select @@identity; ";
        ...
        private const string SqlSelectGetList = "select Id,DepartName,PrevDepartId,DepartManger,ContactTel,ContactFax,Remark,CompanyId,OperatorId,IssueTime from tbl_CompanyDepartment where CompanyId = @CompanyId AND ZxsId=@ZxsId and ";
        private const string SqlSelectGetAllDept = "select Id,DepartName,PrevDepartId,DepartManger,ContactTel,ContactFax,Remark,CompanyId,OperatorId,IssueTime from tbl_CompanyDepartment where CompanyId = @CompanyId AND ZxsId=@ZxsId";
        private const string SqlGetIdByPid = " select Id from tbl_CompanyDepartment where PrevDepartId = @PrevDepartId and CompanyId = @CompanyId AND ZxsId=@ZxsId";
        ...
        public IList<Model.CompanyStructure.Department> GetList(int companyId, int parentDepartId,string zxsId)
        {
            DbCommand cmd;
            ...
            if (parentDepartId == 0)
            {
                ...
                this._db.AddInParameter(cmd1, "ZxsId", DbType.AnsiStringFixedLength, zxsId);
            ...
            this._db.AddInParameter(cmd, "ZxsId", DbType.AnsiStringFixedLength, zxsId);
        ...
        /// <returns></returns>
        public IList<Model.CompanyStructure.Department> GetAllDept(int companyId,string zxsId)
        {
            IList<Model.CompanyStructure.Department> lsDepartment = new List<Model.CompanyStructure.Department>();
