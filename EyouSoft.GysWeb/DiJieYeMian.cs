...
namespace EyouSoft.GysWeb
{
    ...
    /// 供应商后台-地接页面基类
    /// </summary>
    public class DiJieYeMian : System.Web.UI.Page
    {
        #region attributes
        EyouSoft.Model.SSOStructure.MGysYongHuInfo _YongHuInfo = null;
        /// <summary>
        /// 当前用户信息
        /// </summary>
        public EyouSoft.Model.SSOStructure.MGysYongHuInfo YongHuInfo { get { return _YongHuInfo; } }
        bool _IsLogin = false;
        /// <summary>
        /// 是否登录
        /// </summary>
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            _YuMingInfo = EyouSoft.Security.Membership.GysYongHuProvider.GetYuMingInfo();

            if (_YuMingInfo == null) RCWE("请求异常：错误的域名配置。");

            EyouSoft.Model.SSOStructure.MGysYongHuInfo yongHuInfo = null;
            _IsLogin = EyouSoft.Security.Membership.GysYongHuProvider.IsLogin(out yongHuInfo);
