<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiJieJiHuaDan.aspx.cs" Inherits="EyouSoft.GysWeb.danju.DiJieJiHuaDan" Title="计划单" MasterPageFile="~/mp/DanJu.Master" ValidateRequest="false" %>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="40" align="center">
                <b class="font24">
                    <asp:Literal runat="server" ID="ltrZxsName"></asp:Literal>地接安排计划单</b>&nbsp;&nbsp; <span style="font-size: 18px;">(<asp:Literal runat="server" ID="ltrOperatorName"></asp:Literal>)<br />
        ...
        <asp:PlaceHolder runat="server" ID="phYouKeXinXi">
            <tr>
                <td colspan="2" align="left">
                    客人信息：<asp:Literal runat="server" ID="ltrYouKeXinXi"></asp:Literal>
                </td>
            </tr>
        </asp:PlaceHolder>
        <tr>
