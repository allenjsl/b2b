...
namespace EyouSoft.IDAL.CompanyStructure
{
    ...
    public interface IDepartment
    {
        ...
        IList<Model.CompanyStructure.Department> GetList(int companyId, int parentDepartId,string zxsId);
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        IList<Model.CompanyStructure.Department> GetAllDept(int companyId,string zxsId);
