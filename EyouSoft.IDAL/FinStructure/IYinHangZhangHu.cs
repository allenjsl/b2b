...
namespace EyouSoft.IDAL.FinStructure
{
    ...
    public interface IYinHangZhangHu
    {
        ...
        /// <returns></returns>
        IList<CompanyAccount> GetZhangHus(int companyId,string zxsId);
        /// <summary>
        ...
        /// <returns></returns>
        bool IsExistsZhangHao(int companyId, string zhanghuId, string zhangHao,EyouSoft.Model.EnumType.FinStructure.YinHangZhangHuLeiXing leiXing);
        ...
        /// <returns></returns>
        IList<CompanyAccount> GetZhangHus1(int companyId, string zxsId, EyouSoft.Model.CompanyStructure.MYinHangZhangHuChaXunInfo chaXun);
    }
}
