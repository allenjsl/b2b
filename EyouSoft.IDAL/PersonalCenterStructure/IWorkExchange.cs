...
namespace EyouSoft.IDAL.PersonalCenterStructure
{
    ...
    public interface IWorkExchange
    {
        ...
        /// <param name="OperatorId">操作人编号 =0返回所有</param>
        /// <returns>交流专区列表</returns>
        IList<EyouSoft.Model.PersonalCenterStructure.WorkExchange> GetList(
           int pageSize,
           int pageIndex,
           ref int RecordCount,
           int CompanyId,
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.PersonalCenterStructure.WorkExchangeReply> GetList(int CompanyId, int ExchangeId, int pageSize, int pageIndex, ref int RecordCount);
