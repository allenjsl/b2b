<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiPiaoQueRenDan.aspx.cs"
    Inherits="EyouSoft.PtWeb.DanJu.JiPiaoQueRenDan" Title="代订机票+酒店业务确认单" MasterPageFile="~/MP/DanJu.Master"
...
<asp:Content ID="PageMain1" ContentPlaceHolderID="PageMain" runat="server">
    <table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="40" align="center">
                <b class="font24">
                    <asp:Literal runat="server" ID="ltrZxsName"></asp:Literal><asp:Literal runat="server"
                        ID="ltrYeWuLeiXing"></asp:Literal></b>
            </td>
        </tr>
    </table>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            iPage.bindClickByCheckBox("Remark");
