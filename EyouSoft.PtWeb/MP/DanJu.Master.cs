...
namespace EyouSoft.PtWeb.MP
{
    ...
    public partial class DanJu : System.Web.UI.MasterPage
    {
        ...
        void InitInfo()
        {
            ...
            var xiTongPeiZhiInfo = EyouSoft.Security.Membership.TongHangYongHuProvider.GetXiTongPeiZhiInfo(YuMingInfo.CompanyId);
        ...
        string GetDanJuHtml()
        {
            ...
            using (StreamReader sr = new StreamReader(Server.MapPath("danju.html")))
            {
                s=sr.ReadToEnd();
            }
        ...
        string GetDanJuDanYinMoBan()
        {
            ...
            if (_DaYinMoBanLeiXing == DanJuDaYinMoBanLeiXing.NONE
                || _DaYinMoBanLeiXing == DanJuDaYinMoBanLeiXing.ZXS) return moRenMoBan;

            if (_DaYinMoBanLeiXing == DanJuDaYinMoBanLeiXing.KEHU)
            {
                EyouSoft.Model.SSOStructure.MTongHangYongHuInfo huiYuanInfo=null;
                var isLogin = EyouSoft.Security.Membership.TongHangYongHuProvider.IsLogin(out huiYuanInfo);

                if (isLogin)
                {
                    if (!string.IsNullOrEmpty(huiYuanInfo.DanJuDaYinMoBan)) moBan= huiYuanInfo.DanJuDaYinMoBan;
                    else if (!string.IsNullOrEmpty(huiYuanInfo.KeHuDanJuDaYinMoBan)) moBan= huiYuanInfo.KeHuDanJuDaYinMoBan;
                }
            }
