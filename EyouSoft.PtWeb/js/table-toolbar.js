...
var gscx = {
    ...
    _post: function(t, options, pv, fn) {
        ...
        $.ajax({
            ...
            url: "/ashx/handler.ashx?dotype=getgscx&iscy=" + options.t + "&" + $.param(_data),
    ...
    //options={gid:"#国家下拉菜单",sid:"#省份下拉菜单",cid:"#城市下拉菜单",xid:"#县区下拉菜单",gv:"国家选中的值",sv:"省份选中的值",cv:"城市选中的值",xv:"县区选中的值",t:"0所有城市 1常用城市"}
    init: function(options) {
        var _options = { gid: "", sid: "", cid: "", xid: "", gv: "", sv: "", cv: "", xv: "", t: "0" };
...
var pcToobar = {
    ...
    init: function(options) {
        var _options = { gid: options.gID, sid: options.pID, cid: options.cID, xid: options.xID, gv: options.gSelect, sv: options.pSelect, cv: options.cSelect, xv: options.xSelect,  t: options.isCy }
        gscx.init(_options);
    }
};
