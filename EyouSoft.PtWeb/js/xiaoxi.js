...
var xiaoXi = {
    options: { "selectorid": "i_a_wodexiaoxi", "delay": 60000, "xiaoxitiselectorid": "i_div_wodexiaoxi", xiaoxileixing: ["未确认订单", "申请中订单", "名单不全订单", "预留订单", "未确认兑换订单"], cacheexpiration: 20000 }
    , _initStyle: function() {
        var s = [];
    ...
    , _getShuLiang: function() {
        ...
        function _initShuLaing(data) {
            ...
            $("#" + _self.options.selectorid).html('我的消息<b>' + _shuLiang + "</b>");
    ...
    , _goto: function(obj) {
        ...
        switch (_lx) {
            case "0": _url = "/huiyuan/dingdan.aspx?txtDingDanStatus=4"; break;
            case "1": _url = "/huiyuan/dingdan.aspx?txtDingDanStatus=6"; break;
            case "2": _url = "/huiyuan/dingdan.aspx?txtDingDanStatus=5"; break;
            case "3": _url = "/huiyuan/dingdan.aspx?txtDingDanStatus=0"; break;
            case "4": _url = "/huiyuan/jifendingdan.aspx?txtDingDanStatus=0"; break;
            default: break;
        }
    ...
    , _xianShiXiaoXi: function() {
        ...
        $("#" + this.options.xiaoxitiselectorid).find(".item").click(function() { return _self._goto(this); });
    }
    , init: function() {
        var _self = this;
        this._initStyle();
