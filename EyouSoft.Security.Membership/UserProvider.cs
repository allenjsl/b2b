...
namespace EyouSoft.Security.Membership
{
    ...
    public sealed class UserProvider
    {
        ...
        public static int Login(int companyId, string username, PassWord pwdInfo, out MUserInfo uInfo)
        {
            ...
            if (uInfo.ZxsStatus != EyouSoft.Model.EnumType.PtStructure.ZhuanXianShangStatus.启用)
            {
                uInfo = null;
                return -9;
            }
        ...
        public static CompanyFieldSetting GetComSetting(int companyId)
        {
            ...
            if (setting == null)
            {
                ...
                if (setting != null && setting.PrintPageWidth <= 600) setting.PrintPageWidth = 696;
        ...
        public static EyouSoft.Model.CompanyStructure.MZxsPeiZhiInfo GetZxsPeiZhiInfo(int companyId, string zxsId)
        {
            ...
            string cacheName = string.Format(Cache.Tag.TagName.ZxsPeiZhi, companyId, zxsId);
            var info = (MZxsPeiZhiInfo)EyouSoftCache.GetCache(cacheName);

            if (info == null)
            {
                IUserLogin dal = new DUserLogin();
                info = dal.GetZxsPeiZhiInfo(companyId,zxsId);

                EyouSoftCache.Add(cacheName, info);
            }
        ...
        /// <summary>
        /// 获取专线商配置信息(当前登录用户的专线商配置信息)
        /// </summary>
        /// <returns></returns>
        public static EyouSoft.Model.CompanyStructure.MZxsPeiZhiInfo GetZxsPeiZhiInfo()
        {
            ...
            return GetZxsPeiZhiInfo(uInfo.CompanyId, uInfo.ZxsId);
        }
        #endregion
