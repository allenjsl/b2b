                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" 
                                ...
                                <tr>
                                    <td bgcolor="#C1E5F5" align="center">
                                        <input id="select_top_<%#Container.ItemIndex %>" type="checkbox" value='<%#Eval("id") %>'
                                            data-pid='<%#Eval("PrevDepartId") %>' name="Operator3" />
                                        <input id="select_top_<%#Container.ItemIndex %>" type="radio" value="<%#Eval("id") %>"
                                ...
                                <tr>
                                    <td bgcolor="#FFFFFF">
                                        <%#this.GetDepart(Eval("id"),Container.ItemIndex)%>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
