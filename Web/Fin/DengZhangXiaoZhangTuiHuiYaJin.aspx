<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DengZhangXiaoZhangTuiHuiYaJin.aspx.cs" Inherits="Web.Fin.DengZhangXiaoZhangTuiHuiYaJin" MasterPageFile="~/MasterPage/Boxy.Master" %>
                ...
                <ItemTemplate>
                    <tr class="<%# Container.ItemIndex % 2 == 0 ? "even" : "odd" %>">
                        <td height="30" align="center">
                            <input type="checkbox" name="chk" value="<%# Eval("DaiLiId") %>" />
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <%# Eval("YingTuiJinE","{0:F2}")%>
                        </td>
                        <td align="center">
                            <%# this.ToMoneyString((decimal)Eval("TuiYiShenPiJinE") + (decimal)Eval("TuiWeiShenPiJinE"))%>
                        </td>
                        <td align="center">
                            <font class="fred">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            xiaoZhang: function(obj) {
                var _data = { txtDaiLiId: [], txtXiaoZhangJinE: [] };
                var _yz = true;

                $("input[name='chk']:checked").each(function() {
                    var _daiLiId = $(this).val();
                    ...
                    _data.txtDaiLiId.push(_daiLiId);
                    _data.txtXiaoZhangJinE.push(_xiaoZhangJinE);
                });

                if (!_yz) return false;

                if (_data.txtDaiLiId.length == 0) {
