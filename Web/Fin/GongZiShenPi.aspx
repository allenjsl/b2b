<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GongZiShenPi.aspx.cs" Inherits="Web.Fin.GongZiShenPi"
        ...
        <script type="text/javascript">
            var iPage = {
                ...
                shenPi: function(obj) {
                    ...
                    var _confirmmsg = "审批操作不可逆，你确定要审批该工资信息吗？";
                    if (_i_status == "0") _confirmmsg = "审批操作不可逆，你确定要不通过该工资信息吗？";
