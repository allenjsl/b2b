<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QiTaShouRu.aspx.cs" Inherits="Web.Fin.QiTaShouRu"
    MasterPageFile="~/MasterPage/Front.Master" Title="其它收入-财务管理" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="PageBody" runat="server">
            ...
            <td>
                <div class="searchbox">
                    ...
                    <select name="txtXiangMuId" id="txtXiangMuId" class="inputselect">
                        <%=GetJiChuXinXiOptions(EyouSoft.Model.EnumType.CompanyStructure.JiChuXinXiType.其它收入项目,string.Empty) %>
                    </select>
                    ...
                    <input name="txtKeHuName" type="text" class="searchinput formsize100 inputtext" id="txtKeHuName"
                        maxlength="50" /><br />
                    收入金额：<select name="txtJinEOperator" id="txtJinEOperator" class="inputselect"><%=EyouSoft.Common.UtilsCommons.GetEnumDDL(EyouSoft.Common.EnumObj.GetList(typeof(EyouSoft.Model.EnumType.FinStructure.QueryOperator),new string[]{"0"}), "", "0", "-请选择-")%></select>&nbsp;<input
            ...
            <table border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="90" align="center">
                        <a href="javascript:void(0)" id="i_insert">添加收入</a>
                    </td>
                    <td width="90" align="center">
                        <a href="javascript:void(0)" id="a_QiTaShouRu_ToExcel">导 出</a>
                    </td>
                </tr>
            </table>
        </asp:PlaceHolder>
    ...
    <div class="tablelist">
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
            ...
            <asp:Repeater runat="server" ID="rpts">
                <ItemTemplate>
                    <tr class="<%#Container.ItemIndex%2==0?"even":"odd" %>" i_xmid="<%#Eval("ShouRuId") %>" i_kongweiid="<%#Eval("KongWeiId") %>">
                        ...
                        <td align="center">
                            <%#ToMoneyString((decimal)Eval("JinE") - (decimal)Eval("YiShenPiJinE"))%>
                        </td>
                        <td align="center">
                            <%#OperatorHtml%>
                        </td>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function(obj) {
                var _data = {}
                Boxy.iframeDialog({ title: "新增其它收入", iframeUrl: "qitashouruedit.aspx", width: "670px", height: "300px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            //修改、查看
            update: function(obj) {
                var _$tr = $(obj).closest("tr");
                var _data = { shouruid: _$tr.attr("i_xmid"), kongweiid: $.trim(_$tr.attr("i_kongweiid")) };
                var _title = "修改其它收入";
                if ($(obj).attr("i_chakan") == "1") _title = "查看其它收入信息";
                Boxy.iframeDialog({ title: _title, iframeUrl: "qitashouruedit.aspx", width: "670px", height: "300px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            //删除
            del: function(obj) {
                var _$tr = $(obj).closest("tr");
                var _data = { shouruid: _$tr.attr("i_xmid") };
                var _confirmMessage = "其它收入删除后不可恢复，你确定要删除吗？";
                if ($.trim(_$tr.attr("i_kongweiid")).length > 0) _confirmMessage = "该其它收入在团队结算时添加，删除后相关团队结算的其它收入同步删除且不可恢复，你确定要删除吗？";
            ...
            shouKuan: function(obj) {
                var _$tr = $(obj).closest("tr");
                var _data = { xmid: _$tr.attr("i_xmid"), kxtype: "<%=(int)EyouSoft.Model.EnumType.FinStructure.KuanXiangType.其它收入收款 %>" };
                Boxy.iframeDialog({ title: "其它收入收款", iframeUrl: "shoukuan.aspx", width: "900px", height: "400px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            toXls: function() {
        ...
        $(document).ready(function() {
            ...
            $(".i_shoukuan").bind("click", function() { return iPage.shouKuan(this); });
            $("#a_QiTaShouRu_ToExcel").bind("click", function() { return iPage.toXls(); });
        });
    </script>
