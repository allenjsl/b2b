<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QiTaShouRuEdit.aspx.cs"
    Inherits="Web.Fin.QiTaShouRuEdit" MasterPageFile="~/MasterPage/Boxy.Master" %>
            ...
            <tr class="odd">
                ...
                <td bgcolor="#E3F1FC">
                    ...
                    <input name="txtXiangMu" type="text" class="formsize120 inputtext" id="txtXiangMu"
                        runat="server" maxlength="50" valid="required" errmsg="请填写收入项目" />
                </td>
            </tr>
            <tr class="odd">
                ...
                <td colspan="3" bgcolor="#E3F1FC">                    
                    <input name="txtJinE" type="text" class="formsize80 inputtext" id="txtJinE" runat="server"
                        maxlength="11" valid="required|isNumber" errmsg="请填写收入金额|请填写正确的收入金额" />
                </td>
            </tr>
            <tr class="odd">
                <th align="right">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            save: function(obj) {
                ...
                if (_data.txtBeiZhu.length > 255) { parent.tableToolbar._showMsg("收入备注最多可输入255个字符"); return; }
