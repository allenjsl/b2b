...
jQuery.extend({
	...
	acceptData: function( elem ) {
		if ( elem.nodeName ) {
			...
			if ( match ) {
				//解决IE8+ object.getAttribute bug 2014-10-14 汪奇志
				var _attr_classid = elem.getAttribute ? elem.getAttribute("classid") : null;
				return !(match === true || _attr_classid !== match);
			}
		}
...
jQuery.newAjax = function(options) {
    var dataType = "text";
    if (options.dataType) {
