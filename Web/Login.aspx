...
<body style="background:#DEEEFD">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background: url(/images/login05.jpg) repeat-x center top;
        margin: 0; padding: 0;">
        ...
        <tr>
            <td colspan="2" align="center" valign="top" class="textbox" style="background: url(/images/login03.jpg) no-repeat center center;
                height: 186px;">
                <table width="400" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="94" rowspan="3" align="left" valign="middle">
                            <a href="javascript:void(0)" id="lnkLogin" tabindex="4">
                                <img src="/images/login04.jpg" width="68" height="69" alt="" /></a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3" style="text-align:center"><span id="span_msg" style="color:red"></span></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        function login() {
            ...
            blogin5({ u: u, p: p, vc: vc }
                , function(h) {//login success callback
                    ...
                    if (h.indexOf('2,') > -1) {
                        var _options = { yhm: u, mima: p, yzm: "", cookietian: 1, url: h.split(',')[1] };
