<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxList.aspx.cs" Inherits="Web.ManageCenter.AjaxList" %>
...
<cc1:CustomRepeater ID="crptCollectAllList" runat="server">
  <HeaderTemplate>
        <table width="750" border="0"  align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse; line-height:16px;" class="list">
