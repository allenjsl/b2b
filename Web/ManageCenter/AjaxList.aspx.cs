...
namespace Web.ManageCenter
{
    ...
    /// 日期：2011-01-18
    /// </summary>
    public partial class AjaxList : BackPage
    {
        #region 页面参数
        protected int Year;
        protected int Month;
        ...
        private void BindDataPersonalList()
        {
            ...
            {
                this.crptPersonalList.EmptyText = "<table width=\"750\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"#000000\" style=\"border-collapse:collapse; line-height:16px;\"><tr><td colspan=\"7\"><div style=\"text-align:center;  margin-top:75px; margin-bottom:75px;\">没有相关的数据!</span></div></td></tr></table>";
            }
        }
        ...
        protected string GetAttendanceDetails(object ListAttendanceInfo,int StaffNo)
        {
            ...
            sb.Append("<table width=\"750\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"#000000\" style=\"border-collapse:collapse; line-height:16px;\" class=\"list\">");
        ...
        private string GetStatus(IList<EyouSoft.Model.AdminCenterStructure.AttendanceInfo> listAttendance, DateTime dt)
        {
            ...
            if (listAttendance != null)
            {
                ...
                {
                    if (dt.Date.CompareTo(listAttendance[i].AddDate.Date)==0)
                    {
        ...
        private void BindDateAllList()
        {
            ...
            if (listAttendanceByDepartment != null && listAttendanceByDepartment.Count > 0)
            {
                ...
                if (flag)
                {
                    this.crptCollectAllList.EmptyText = "<table width=\"750\" border=\"1\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"#000000\" style=\"border-collapse:collapse; line-height:16px;\"><tr><td colspan=\"34\"><div style=\"text-align:center;  margin-top:75px; margin-bottom:75px;\">没有相关的数据!</span></div></td></tr></table>";
                }
                else
                {
