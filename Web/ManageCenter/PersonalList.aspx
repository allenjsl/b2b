<%@ Page Language="C#" MasterPageFile="/masterpage/Print.Master" AutoEventWireup="true" CodeBehind="PersonalList.aspx.cs" Inherits="Web.ManageCenter.PersonalList" ValidateRequest="false" Title="个人考勤表_行政中心" %>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="35" align="center"><h2><strong>个人考勤表</strong></h2></td>
  </tr>
</table>
<div ref="noprint">
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input type="button" name="txt_Submit" id="txt_Submit" value="查询" onclick="PersonalList.OnSearch();" />
    </td>
  </tr>
</table>
</div>
