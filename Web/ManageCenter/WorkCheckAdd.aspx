<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkCheckAdd.aspx.cs" Inherits="Web.ManageCenter.WorkCheckAdd" %>
...
<body>
    ...
    <table width="500" cellspacing="1" cellpadding="0" border="0" align="center" style="margin: 20px;">
        <tbody>
            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td width="86" height="40" align="center" class="tjbtn02">
                                    <a href="javascript:void(0);" hidefocus="true" id="btnSave" style='visibility:<%=IsAddGrant?"visible":"hidden" %>'>确认</a>
                                </td>
                                <td width="86" height="40" align="center" class="tjbtn02">
                                    <a href="javascript:void(0);" onclick="PageJsData.CloseForm()" hidefocus="true" class="chongzhi">取消</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        var PageJsData = {
        	...
        	Save: function() {
        		...
        		if (that.FormCheck()) {
        			...
        			var url = "/ManageCenter/WorkCheckAdd.aspx?";
        			url += $.param({
        	...
        	BindBtn: function() {
        		$("#btnSave").click(function() {
        			...
        			if (arry.length > 2) {
        				...
        				$("#<%=sTime.ClientID %>").val($(arry[2]).val());
        				$("#<%=eTime.ClientID %>").val($(arry[3]).val());
        				$("#<%=timeCount.ClientID %>").val($(arry[4]).val());
