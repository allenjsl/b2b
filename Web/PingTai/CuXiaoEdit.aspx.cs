...
namespace Web.PingTai
{
    ...
    /// 促销信息编辑
    /// </summary>
    public partial class CuXiaoEdit : EyouSoft.Common.Page.BackPage
    {
        ...
        /// 促销状态
        /// </summary>
        protected EyouSoft.Model.EnumType.PtStructure.CuXiaoStatus CuXiaoStatus = EyouSoft.Model.EnumType.PtStructure.CuXiaoStatus.正常;
        #endregion
        ...
        void InitInfo()
        {
            ...
            var info = new EyouSoft.BLL.PtStructure.BCuXiao().GetInfo(EditId);
        ...
        /// </summary>
        /// <returns></returns>
        EyouSoft.Model.PtStructure.MCuXiaoInfo GetFormInfo()
        {
            ...
            info.Status = Utils.GetEnumValue<EyouSoft.Model.EnumType.PtStructure.CuXiaoStatus>(Utils.GetFormValue("txtStatus"), EyouSoft.Model.EnumType.PtStructure.CuXiaoStatus.正常);
        ...
        void BaoCun()
        {
            ...
            if (string.IsNullOrEmpty(info.CuXiaoId))
            {
            ...
            if (string.IsNullOrEmpty(info.CuXiaoId))
            {
                bllRetCode = new EyouSoft.BLL.PtStructure.BCuXiao().Insert(info);
            }
            else
            {
                bllRetCode = new EyouSoft.BLL.PtStructure.BCuXiao().Update(info);
            }
