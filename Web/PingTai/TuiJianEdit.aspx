<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TuiJianEdit.aspx.cs" Inherits="Web.PingTai.TuiJianEdit" MasterPageFile="~/MasterPage/Boxy.Master" ValidateRequest="false"%>
...
<asp:Content runat="server" ContentPlaceHolderID="PageBody" ID="PageBody">
            ...
            <tr class="odd">
                ...
                <td style="background:#E3F1FC">
                    <input name="txtBiaoTi" type="text" class="inputtext" id="txtBiaoTi" runat="server"
                        valid="required" errmsg="请填写推荐标题" maxlength="100" style="width:280px;" />
                </td>
            </tr>
            <tr class="odd">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#txtStatus").val("<%=(int)TuiJianStatus %>");
        });
    </script>
</asp:Content>
