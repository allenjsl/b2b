<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WangZhanJiChuXinXi2.aspx.cs" Inherits="Web.PingTai.WangZhanJiChuXinXi2" MasterPageFile="~/MasterPage/Front.Master" Title="联系方式-平台基础信息-同行端口" ValidateRequest="false"%>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="85%" nowrap="nowrap" align="right" style="padding: 0 10px 2px 0; color: #13509f;">
                              所在位置&gt;&gt; <a href="javascript:void(0)">同行端口</a>&gt;&gt; 平台基础信息-联系方式
                            </td>
                        </tr>
                        <tr>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            baoCun: function(obj) {
                ...
                $.ajax({ type: "post", cache: false, url: "WangZhanJiChuXinXi2.aspx?dotype=baocun", data: $("#<%=form1.ClientID %>").serialize(), dataType: "json",
