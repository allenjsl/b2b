...
namespace Web.PingTai
{
    ...
    /// 平台基础信息-联系方式
    /// </summary>
    public partial class WangZhanJiChuXinXi2 : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void InitInfo()
        {
            var info1 = new EyouSoft.BLL.PtStructure.BPt().GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.PtStructure.KvKey.联系方式);
            txt1.Value = info1.V;
        }
        ...
        void BaoCun()
        {
            ...
            info1.K = EyouSoft.Model.EnumType.PtStructure.KvKey.联系方式;
