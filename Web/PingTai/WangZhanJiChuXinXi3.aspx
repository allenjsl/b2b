<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WangZhanJiChuXinXi3.aspx.cs" Inherits="Web.PingTai.WangZhanJiChuXinXi3" MasterPageFile="~/MasterPage/Front.Master" Title="免责声明-平台基础信息-同行端口" ValidateRequest="false"%>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="85%" nowrap="nowrap" align="right" style="padding: 0 10px 2px 0; color: #13509f;">
                              所在位置&gt;&gt; <a href="javascript:void(0)">同行端口</a>&gt;&gt; 平台基础信息-免责声明
                            </td>
                        </tr>
                        <tr>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            baoCun: function(obj) {
                ...
                $.ajax({ type: "post", cache: false, url: "WangZhanJiChuXinXi3.aspx?dotype=baocun", data: $("#<%=form1.ClientID %>").serialize(), dataType: "json",
