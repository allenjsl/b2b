...
namespace Web.PingTai
{
    ...
    /// 平台基础信息-免责声明
    /// </summary>
    public partial class WangZhanJiChuXinXi3 : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void InitInfo()
        {
            var info1 = new EyouSoft.BLL.PtStructure.BPt().GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.PtStructure.KvKey.免责声明);
            txt1.Value = info1.V;
        }
        ...
        void BaoCun()
        {
            ...
            info1.K = EyouSoft.Model.EnumType.PtStructure.KvKey.免责声明;
