...
namespace Web.PingTai
{
    ...
    /// 专线商权限模板权限管理
    /// </summary>
    public partial class ZhuanXianShangPrivsMoBanPrivsEdit : BackPage
    {
        #region attributes
        /// <summary>
        /// 权限模板编号
        ...
        void InitPrivs()
        {
            ...
            if (Privs_GuanLi) ltrOperatorHtml.Text = "<a href=\"javascript:void(0)\" id=\"i_a_save\">保存</a>";
        ...
        void InitInfo()
        {
            var moBanInfo = new EyouSoft.BLL.PtStructure.BZxsPrivsMoBan().GetInfo(EditId);
            if (moBanInfo == null) Utils.RCWE("异常请求");
            ...
            string script = "var moBanPrivs={0};";
            var obj = new { privs1 = moBanInfo.Privs1, privs2 = moBanInfo.Privs2, privs3 = moBanInfo.Privs3 };
        ...
        void Save()
        {
            ...
            int bllRetCode = new EyouSoft.BLL.PtStructure.BZxsPrivsMoBan().SheZhiPrivs(CurrentUserCompanyID, EditId, _privs1, _privs2, _privs3);
