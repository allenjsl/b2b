<%@ Page Title="代订酒店业务确认单" Language="C#" MasterPageFile="~/MasterPage/Print.Master"
    AutoEventWireup="true" CodeBehind="ScheduleHotel.aspx.cs" Inherits="Web.PrintPage.ScheduleHotel" ValidateRequest="false" %>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
            <td width="45%" align="left">
                传真(Fax)：<asp:Literal runat="server" ID="ltrBuyCompanyFax"></asp:Literal>
            </td>
            <td align="left">
