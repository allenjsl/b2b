...
{
    public partial class GysYongHu : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        /// <summary>
        /// 栏目权限
        ...
        void InitPrivs()
        {
            Privs_LanMu = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.资源管理_地接社账号管理_栏目);
            Privs_GuanLi = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.资源管理_地接社账号管理_账号管理);
