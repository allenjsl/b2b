<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartAdd.aspx.cs" Inherits="Web.SystemSet.DepartAdd" %>
    ...
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="1" style="margin: 20px auto;">
        <tr class="odd">
            ...
            <td width="36%" bgcolor="#E3F1FC">
                <input type="text" class="xtinput" id="txtDepName" size="20" runat="server" valid="required"
                    maxlength="15" errmsg="部门不为空" />
        ...
        <tr class="odd">
            ...
            <td width="36%" bgcolor="#E3F1FC">
                <input type="text" class="xtinput" runat="server" id="txtTel" size="20" valid="isPhone"
                    errmsg="格式不正确" />
            ...
            <td width="36%" bgcolor="#E3F1FC">
                <input type="text" runat="server" class="xtinput" id="txtFax" size="25" />
            </td>
        </tr>
        <tr class="odd">
            <th width="13%" height="30" align="right">
            ...
            <td colspan="3" bgcolor="#E3F1FC">
                <textarea name="txtRemark" id="txtRemark" cols="55" rows="5" runat="server"></textarea>
            </td>
        </tr>
        <tr class="odd">
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="76" height="40" align="center" class="tjbtn02">
                            <a href="javascript:;" id="btn_save" onclick="return De.save('');">保存</a>
                        </td>
