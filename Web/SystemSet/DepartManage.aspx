    ...
    <script type="text/javascript">
        ...
        var DM = {
            ...
            openDialog: function(p_url, p_title, tar_a) {
                Boxy.iframeDialog({ title: p_title, iframeUrl: p_url, width: "640px", height: "380px", tar: tar_a, afterHide: function() { DM.reload(); } });
            },
            ...
            updateD: function(dId, tar_a) {
                DM.openDialog("/SystemSet/DepartAdd.aspx?method2=update&departId=" + dId, "修改部门", tar_a);
                return false;
            },
            //添加下级部门
            addD: function(dId, tar_a) {
                DM.openDialog("/SystemSet/DepartAdd.aspx?method2=add&departId=" + dId, "添加部门");
                return false;
            },
            //添加下级部门后回调
