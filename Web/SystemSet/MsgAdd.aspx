<%@ Page Title="信息详情" Language="C#" MasterPageFile="/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="MsgAdd.aspx.cs" Inherits="Web.SystemSet.MsgAdd" ValidateRequest="false" %>
            ...
            <table width="800" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#BDDCF4">
                ...
                <tr>
                    ...
                    <td width="84%" height="35" colspan="2" align="left" bgcolor="#FAFDFF" class="pandl3">
                        <input class="inputtext" id="txtInfoTitle" runat="server" type="text" size="50" valid="required"
                            errmsg="标题不为空" />
                ...
                <tr>
                    ...
                    <td height="35" colspan="2" align="left" bgcolor="#FAFDFF" class="pandl3">
                        ...
                        <a href="javascript:;" onclick="return InfoEdit.selDeaprt();">指定部门<img src="/images/icon_select.jpg"
                            alt="" /></a>
                    ...
                    <td height="30" colspan="3" align="center">
                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="137" height="20" align="center" class="tjbtn02">
                                    <a href="/systemset/MsgManageList.aspx">返回</a>
                                </td>
                            </tr>
                        </table>
                    </td>
