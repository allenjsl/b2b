<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuChengShiJian.aspx.cs"
    Inherits="Web.SystemSet.QuChengShiJian" MasterPageFile="~/MasterPage/Front.Master"
    Title="去程时间-基础设置-系统设置" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="PageBody" runat="server">
    ...
    <uc1:JiChuXinXi runat="server" ID="JiChuXinXi1" HighlightNav="0" />
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function(obj) {
                var _data = {}
                Boxy.iframeDialog({ title: "新增去程时间", iframeUrl: "quchengshijianedit.aspx", width: "470px", height: "140px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            //修改、查看
            update: function(obj) {
                ...
                var _title = "去程时间修改";
                Boxy.iframeDialog({ title: _title, iframeUrl: "quchengshijianedit.aspx", width: "470px", height: "140px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            //删除
            del: function(obj) {
                if (!confirm("去程时间信息删除后不可恢复，你确定要删除吗？")) return;
                var _$tr = $(obj).closest("tr");
