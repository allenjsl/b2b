...
namespace Web.SystemSet
{
    ...
    /// 系统设置-基础设置-去程时间
    /// </summary>
    public partial class QuChengShiJian : BackPage
    {
        #region attributes
        ...
        void InitPrivs()
        {
            Privs_LanMu = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.系统设置_基础设置_去程时间栏目);
            ...
            if (!Privs_LanMu)
            {
                ...
                {
                    Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs3.系统设置_基础设置_去程时间栏目, true);
                }
            }
        }
        ...
        {            
            ...
            var items = new EyouSoft.BLL.CompanyStructure.BJiChuXinXi().GetJiChuXinXis(CurrentUserCompanyID, EyouSoft.Model.EnumType.CompanyStructure.JiChuXinXiType.去程时间, pageSize, pageIndex, ref recordCount, chaXun);
