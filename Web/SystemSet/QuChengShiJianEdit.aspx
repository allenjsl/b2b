<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuChengShiJianEdit.aspx.cs"
    Inherits="Web.SystemSet.QuChengShiJianEdit" MasterPageFile="~/MasterPage/Boxy.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="PageBody" ID="PageBody">
    <div style="width: 450px; margin: 10px auto;">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" id="i_table_form">
            <tr class="odd">
                <th width="120" height="50" align="right">
                    去程时间：
                </th>
                <td style="background: #E3F1FC">
                    <input name="txtName" type="text" class="formsize180 inputtext" id="txtName" runat="server" valid="required" errmsg="请填写去程时间" maxlength="20" />
                </td>
            </tr>
        </table>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            save: function(obj) {
                var _data = { txtName: $.trim($("#<%=txtName.ClientID %>").val()) };
