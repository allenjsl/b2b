<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleEdit.aspx.cs" Inherits="Web.SystemSet.RoleEdit" %>
...
<table width="304" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <asp:PlaceHolder runat="server" ID="phBaoCun">
            <td width="152" height="40" align="center" class="tjbtn02"><a href="javascript:;" onclick="return RoleEdit.setPer();">保存</a></td></asp:PlaceHolder>
            <td width="152" height="40" align="center" class="tjbtn02"><span class="tjbtn02"><a href="RoleList.aspx" >关闭</a></span></td>
  </tr>
     </table>
    </form>
