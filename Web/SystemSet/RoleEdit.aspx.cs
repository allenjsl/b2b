    ...
    public partial class RoleEdit : BackPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (method2 != "save")
            {
                ...
                {//如果角色编号不为0则加载角色信息
                    ...
                    if (roleModel != null)
                    {
                        ...
                        if (roleName == "管理员") phBaoCun.Visible = false;
                    }//获取设置角色拥有的权限
                }
                #endregion
            }
            else
            {
                ...
                MessageBox.ResponseScript(this, string.Format(";alert('{0}'); window.parent.location='/SystemSet/RoleList.aspx';", showMess));
                return;
                #endregion
            }
