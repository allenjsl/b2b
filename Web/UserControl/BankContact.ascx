<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BankContact.ascx.cs"
    Inherits="Web.UserControl.BankContact" %>
...
<script type="text/javascript">
    $(function() {
        $("#tabBankAccount").autoAdd({ tempRowClass: "tempRow", addButtonClass: "addbtn_a", delButtonClass: "delbtn_a", indexClass: "indexcontact" })
