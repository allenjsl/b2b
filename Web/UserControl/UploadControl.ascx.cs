...
namespace Web.UserControl
{
    public partial class UploadControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(TiShiXinXi))
            {
                ltrTiShiXinXi.Text = string.Format("<span style=\"float:left; line-height:40px;color:#666\">{0}</span>", TiShiXinXi);
            }
        }
        ...
        /// 提示信息
        /// </summary>
        public string TiShiXinXi { get; set; }
