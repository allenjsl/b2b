...
namespace Web.Webmaster
{
    ...
    public partial class login : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //var items = new EyouSoft.BLL.TongJiStructure.BCaoZuoRen().GetCaoZuoRens(1, null);
            //var items = new EyouSoft.BLL.TongJiStructure.BLxsRenTou().GetLxsRenTous(1, 2012, EyouSoft.Model.EnumType.CompanyStructure.ChengShiDiQu.其它地区, null);
            //int recordCount = 0;
            //object[] heJi;
            //var items = new EyouSoft.BLL.FinStructure.BGongZi().GetGongZis(1, 1, 1, ref recordCount, null, out heJi);
        }
