...
namespace Web.Webmaster
{
    ...
    public partial class _privs : WebmasterPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(sysInfo.ZxsId))
            {
                RegisterAlertAndRedirectScript("异常：系统未添加主专线商。", "systems.aspx");
            }
        ...
        void InitPrivs()
        {
            ...
            {
                html.Append("<div class=\"privs123\">");
                html.AppendFormat("<div class=\"privs1\"><input type=\"checkbox\" id=\"chk_p_1_{1}\" value=\"{1}\" name=\"chk_p_1\" /><label for=\"chk_p_1_{1}\">{0}</label><!--<span class=\"pcode\">[{1}]</span>--></div>", menu1.Name, menu1.MenuId);
                ...
                {
                    html.Append("<ul class=\"privs2\">");
                    html.AppendFormat("<li class=\"privs2title\"><input type=\"checkbox\" id=\"chk_p_2_{1}\" value=\"{1}\" name=\"chk_p_2\" /><label for=\"chk_p_2_{1}\">{0}</label><!--<span class=\"pcode\">[{1}]</span>--></li>", menu2.Name, menu2.MenuId);
                    ...
                    if (privs != null && privs.Count > 0)
                    {
                        ...
                        {
                            html.AppendFormat("<li class=\"privs3\"><input type=\"checkbox\" id=\"chk_p_3_{1}\" value=\"{1}\" name=\"chk_p_3\"  /><label for=\"chk_p_3_{1}\">{0}</label><span class=\"pcode\">[{1}]</span></li>", priv.Name, priv.PrivsId);
                        }
                    }
                    ...
                    if (i % 4 == 3)
                    {
                        html.Append("<ul class=\"privs2space\"><li></li></ul>");
                    }
                    i++;
                }
