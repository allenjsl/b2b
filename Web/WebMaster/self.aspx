...
<asp:Content runat="server" ContentPlaceHolderID="PageContent" ID="MainContent">
    <table cellpadding="2" cellspacing="1" style="font-size: 12px; width: 100%;">
        ...
        <tr>
            <td><b style="font-size:14px;">常用工具：</b></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>
                <input id="t_cache_name" class="input_text" name="t_cache_name" type="text" maxlength="100"
                    style="width: 200px" />
        ...
        <tr>
            <td>
                <asp:Button ID="btnKillWINWORD" runat="server" Text="清理Word进程" OnClick="btnKillWINWORD_Click" />
                <asp:Button ID="btnKillEXCEL" runat="server" Text="清理Excel进程" OnClick="btnKillEXCEL_Click" />
                <asp:Button ID="btnRestart" runat="server" Text="重启应用程序" OnClick="btnRestart_Click" />
            </td>
        </tr>
        <tr>
            <td>
