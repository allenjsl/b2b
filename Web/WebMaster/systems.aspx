        ...
        <ItemTemplate>
            <tr onmouseover="changeTrBgColor(this,'#eeeeee')" onmouseout="changeTrBgColor(this,'#ffffff')">
                ...
                <td style="text-align:left;">&nbsp;&nbsp;
                    <a href="system.aspx?sysid=<%#Eval("SysId") %>&cid=<%#Eval("CompanyId") %>&zxsid=<%#Eval("ZxsId") %>">查看</a>&nbsp;
                    <a href="domain.aspx?sysid=<%#Eval("SysId") %>&cid=<%#Eval("CompanyId") %>&zxsid=<%#Eval("ZxsId") %>">域名</a>&nbsp;
                    <a href="privs.aspx?sysid=<%#Eval("SysId") %>&cid=<%#Eval("CompanyId") %>&zxsid=<%#Eval("ZxsId") %>&uid=<%#Eval("UserId") %>">权限</a>&nbsp;
